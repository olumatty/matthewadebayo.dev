...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  const isLong = (isString(title) ? title.length : 0) > 35;
    ...
    <div style={styles.container}>
      ...
      >
        ...
        >
          <img
            alt="Matthew Adebayo"
            src="https://res.cloudinary.com/dynnrnlzx/image/upload/v1760791765/black-businesswoman-shaking-hands-with-male-partner_e77lln.jpg"
            height={50}
            style={{ objectFit: 'contain', borderRadius: '50%' }}
          />
        </div>
        <p style={{ fontSize: '20px' }}>Written by Matthew Adebayo</p>
      </div>
