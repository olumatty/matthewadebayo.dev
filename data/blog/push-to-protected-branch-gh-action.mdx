...
While working to improve the CI workflows in Chakra UI, we wanted to create a Github action that updates the changelog anytime we release a new version. The github action looked like this:
